/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars=false src/server/worker-configuration.d.ts` (hash: d70c0ef314dc685ffde7a92ff4a65c8e)
// Runtime types generated with workerd@1.20260721.1 2026-07-17 nodejs_compat
interface __BaseEnv_Env {
	OATH_RATE_LIMITER: RateLimit;
	OATH_MCP_MODE: string;
	OATH_ALLOWED_ORIGINS: string;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("../../dist/server/worker");
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "OATH_MCP_MODE" | "OATH_ALLOWED_ORIGINS">> {}
}
